...
// - Helper ImGui_ImplVulkanH_XXX functions and structures are only used by this example (_main.cpp) and by
...
// (Used by example's _main.cpp. Used by multi-viewport features. PROBABLY NOT used by your own app.)
//-------------------------------------------------------------------------
// You probably do NOT need to use or care about those functions.
// Those functions only exist because:
//   1) they facilitate the readability and maintenance of the multiple _main.cpp examples files.
...
void ImGui_ImplVulkanH_CreateWindowSwapChain(VkPhysicalDevice physical_device, VkDevice device, ImGui_ImplVulkanH_Window* wd, const VkAllocationCallbacks* allocator, int w, int h, uint32_t min_image_count)
{
    ...
    if (wd->UseDynamicRendering == false)
    {
        ...
        // We do not create a pipeline by default as this is also used by examples' _main.cpp,
